                ...
                <tr class="border-b border-gray-700 hover:bg-white hover:bg-opacity-5 transition
                  ...
                  <td class="py-4 px-6">
                    <div class="flex items-center space-x-2">
                      <button wire:click="updateQuantity({{ $item->cart_id }}, {{ $item->quantity - 1 }})"
                              class="w-8 h-8 bg-gray-700 hover:bg-gray-600 text-white rounded-full flex items-center justify-center transition"
